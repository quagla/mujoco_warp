...
def ccd_kernel_builder(
  ...
  def ccd_kernel(
    ...
    multicdd_pdist_in: wp.array2d(dtype=float),
    multicdd_idx1_in: wp.array2d(dtype=int),
    multicdd_idx2_in: wp.array2d(dtype=int),
    multicdd_n1_in: wp.array2d(dtype=wp.vec3),
    multicdd_n2_in: wp.array2d(dtype=wp.vec3),
    multicdd_endvert_in: wp.array2d(dtype=wp.vec3),
    multicdd_face1_in: wp.array2d(dtype=wp.vec3),
    multicdd_face2_in: wp.array2d(dtype=wp.vec3),
    # Data out:
    ...
    if wp.static(legacy_gjk):
      ...
      dist, count, witness1, witness2 = ccd(
        ...
        multicdd_pdist_in[tid],
        multicdd_idx1_in[tid],
        multicdd_idx2_in[tid],
        multicdd_n1_in[tid],
        multicdd_n2_in[tid],
        multicdd_endvert_in[tid],
        multicdd_face1_in[tid],
        multicdd_face2_in[tid],
      )
      if dist >= 0.0:
        count = 0
        return
