...
class Data:
  ...
  Attributes:
    ...
    multicdd_pdist: plane distance of clipping polygon          (nconmax, max_npolygon)
    multicdd_idx1: list of normal index candidates for Geom 1   (nconmax, max_meshdegree)
    multicdd_idx2: list of normal index candidates for Geom 2   (nconmax, max_meshdegree)
    multicdd_n1: list of normal candidates for Geom 1           (nconmax, max_meshdegree)
    multicdd_n2: list of normal candidates for Geom 1           (nconmax, max_meshdegree)
    multicdd_endvert: list of edge vertices candidates          (nconmax, max_meshdegree)
    multicdd_face1: contact face                                (nconmax, max_npolygon)
    multicdd_face2: contact face                                (nconmax, max_npolygon)
  ...
  multicdd_pdist: wp.array2d(dtype=float)
  multicdd_idx1: wp.array2d(dtype=int)
  multicdd_idx2: wp.array2d(dtype=int)
  multicdd_n1: wp.array2d(dtype=wp.vec3)
  multicdd_n2: wp.array2d(dtype=wp.vec3)
  multicdd_endvert: wp.array2d(dtype=wp.vec3)
  multicdd_face1: wp.array2d(dtype=wp.vec3)
  multicdd_face2: wp.array2d(dtype=wp.vec3)
